...
import {
    ...
    PiExpressionCreator,
    PiActions,
    Box, PiEditor, AliasBox, PiCaret, triggerToString, PiTriggerType, PiElement
} from "@projectit/core";
...
export const MANUAL_CUSTOM_BEHAVIORS: PiCustomBehavior[] = [
    // Add your own custom behavior here
    {
        ...
        action: (box: Box, trigger: PiTriggerType, ed: PiEditor): PiElement | null => {
            ...
            const newElement = new Org_iets3_core_expr_simpleTypes_NumberLiteral();
            newElement.value = triggerToString(trigger);
